...
while True:
    ...
    while run:
        ...
        playerzsHitgunBpenisaddies = pygame.sprite.groupcollide(playerzs, gunBaddies, False, True)
        knifeBaddiesHitpenisknifeBaddies = pygame.sprite.groupcollide(knifeBaddies, knifeBaddies, False, False)
